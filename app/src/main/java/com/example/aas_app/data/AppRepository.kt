    ...
    suspend fun prePopulateAll(): AppResult<Unit> {
        return try {
            db.withTransaction {
                ...
                // Questions - Full list from provided database
                val questionData = listOf(
                    ...
                    PeclQuestionEntity(subTask = "f. Actions on enemy contact (5 of 5)", controlType = "OptionButton", scale = "Scale_Go_NOGO", criticalTask = "NO") to "Issue an Operations Order",
                    ...
                    PeclQuestionEntity(subTask = "5- Abort criteria (company OPORD)", controlType = "OptionButton", scale = "Scale_Go_NOGO", criticalTask = "NO") to "Issue an Operations Order",
                    ...
                    PeclQuestionEntity(subTask = "b. Actions at haly (long and short)", controlType = "OptionButton", scale = "Scale_Go_NOGO", criticalTask = "NO") to "Issue an Operations Order",
                    ...
                    PeclQuestionEntity(subTask = "2- Location of tentative initial entry point.", controlType = "OptionButton", scale = "Scale_Go_NOGO", criticalTask = "NO") to "Issue an Operations Order",
                    ...
                    PeclQuestionEntity(subTask = "5- Priorities fot the leader's reconnaissance and what must be accomplished", controlType = "OptionButton", scale = "Scale_Go_NOGO", criticalTask = "NO") to "Issue an Operations Order",
                    ...
                    PeclQuestionEntity(subTask = "8- Dissimination of information", controlType = "OptionButton", scale = "Scale_Go_NOGO", criticalTask = "NO") to "Issue an Operations Order",
                    ...
                    PeclQuestionEntity(subTask = "1- Leg/Distance/Direction/Time/Mode of travel/FOOM/Terrain/Fires/HLZ/CCP/Battle Drills/RV", controlType = "OptionButton", scale = "Scale_Go_NOGO", criticalTask = "NO") to "Issue an Operations Order",
                    PeclQuestionEntity(subTask = "2- Location of tentative initial entry point", controlType = "OptionButton", scale = "Scale_Go_NOGO", criticalTask = "NO") to "Issue an Operations Order",
                    PeclQuestionEntity(subTask = "e. Actions on enemy contact", controlType = "OptionButton", scale = "Scale_Go_NOGO", criticalTask = "NO") to "Issue an Operations Order",
                    PeclQuestionEntity(subTask = "f. Actions at planned, suspected, linear and open danger areas.", controlType = "OptionButton", scale = "Scale_Go_NOGO", criticalTask = "NO") to "Issue an Operations Order",
                    PeclQuestionEntity(subTask = "g. Actions at extraction site (3 of 3)", controlType = "OptionButton", scale = "Scale_Go_NOGO", criticalTask = "NO") to "Issue an Operations Order",
                    ...
                    PeclQuestionEntity(subTask = "b. Location of PZ (3 of3)", controlType = "OptionButton", scale = "Scale_Go_NOGO", criticalTask = "NO") to "Issue an Operations Order",
