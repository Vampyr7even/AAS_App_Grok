...
interface EvaluationResultDao {
    ...
    fun insertEvaluationResult(result: PeclEvaluationResultEntity): Long
    ...
    fun getAverageScoreForStudent(studentId: Long, poiId: Long): Double

    @Query("SELECT * FROM pecl_evaluation_results WHERE question_id = :questionId")
    fun getEvaluationsForQuestion(questionId: Long): List<PeclEvaluationResultEntity>
}