...
fun SubTasksTab(
    ...
    val questionsState by adminViewModel.questionsState.observeAsState(AppState.Success(emptyList()))
    val scalesState by adminViewModel.scalesState.observeAsState(AppState.Success(emptyList()))
    val tasksState by adminViewModel.tasksState.observeAsState(AppState.Success(emptyList()))
    ...
    LaunchedEffect(Unit) {
        try {
            ...
            adminViewModel.loadTasksForPoi(0L)
        } catch (e: Exception) {
